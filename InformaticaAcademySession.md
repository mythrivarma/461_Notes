...
* Debug Mode: Mappings>Debugger> Start Debugger. 'Create a debug sessoin instance' will create a temporary session (like a # table win SQL Server). 'Discard target Data' option will ensure that physicaly the target will not have any kind of impact. 
